...
class MilitarService {
    ...
    public function salvarMilitar(array $dados): int {
        ...
        $parametros = [
            ...
            ':subunidade' => $dados['subunidade'] ?: null,
            ':pelotao' => $dados['pelotao'] ?: null,
            ...
            ':dt_praca' => $dados['dt_praca'] ?: null,
            ':idt_militar' => $dados['idt_militar'] ?: null,
            ':email' => strtolower(trim($dados['email'])),
            ':celular_princ' => $dados['celular_princ'] ?: null,
            ':celular_sec' => $dados['celular_sec'] ?: null,
            ':nome_resp' => strtoupper(trim($dados['nome_resp'])),
            ':tel_resp' => $dados['tel_resp'] ?: null,
            ':tel_emergencia' => $dados['tel_emergencia'] ?: null,
            ':cep' => $dados['cep'] ?: null,
            ':endereco' => strtoupper(trim($dados['endereco'])),
            ':num_residencia' => $dados['num_residencia'] ?: null,
            ':bairro' => strtoupper(trim($dados['bairro'])),
            ':cidade' => strtoupper(trim($dados['cidade'])),
            ':estado' => $dados['estado'] ?: null,
            ':cat_cnh' => $dados['cat_cnh'] ?: null,
            ':validade_cnh' => $dados['validade_cnh'] ?: null,
        ];
